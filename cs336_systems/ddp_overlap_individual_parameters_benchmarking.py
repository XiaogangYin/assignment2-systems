...
from cs336_systems.ddp import  DDPIndividualParameters as DDP
...
def run_gpt(rank: int,
    ...
    base_model = BasicsTransformerLM(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta).to(get_device())
    ...
    print(f"{rank}, total time: {total_time/(num_steps-1)}, reduce time: {reduce_time/(num_steps-1)} ")
